...
public class DataFile {
    ...
    public DataFile(String suffix) throws IOException {
        if (EnableFileWritting) {
            ...
            System.out.println("Skipping writting data to file " + suffix + ", renable with DataFile.EnableFileWritting");
        }
    }
